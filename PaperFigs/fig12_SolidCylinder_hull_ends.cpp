...
/*
    In this example we generate a  cyllinder and attach polymers to the hull,
    and rods to the ends of the cyllinder.
*/
...
int main()
{
    ...
    for (int i=0; i<N; i++)
      {
          ...
          string cyllinderref1  = "cylinder.hull#p"+to_string(i);
          w.Link( "GaussianPolymer",  polyname, cyllinderref1, "poly");

          string rodname     = "rod"+to_string(i)+".end1";
          string cyllinderref2  = "cylinder.ends#r"+to_string(i);
    ...
    w.Evaluate( F, params, qvec, "fig12e.q", "50 polymers attached to the hull + 50 rods attached to the ends of a cyllinder.");
}
