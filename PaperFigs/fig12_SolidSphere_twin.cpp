...
/*
    In this example we generate a sphere with a polymer and rod pairs attached randomly to its surface.
*/
...
int main()
{
    ...
    for (int i=0; i<N; i++)
      {
          ...
          string sphereref2  = "sphere.surface#p"+to_string(i);
    ...
    w.Evaluate( F, params, qvec, "fig12b.q", "Form factor of 50 polymers and 50 rods pairs attached to 50 random pointd a sphere.");
}
